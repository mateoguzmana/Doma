...
$IdUS						=	$_REQUEST['Id']; 
					...
					$NombreTITMEN		=$rowTITMEN["Nombre"];
					 ...
					 $query			="SELECT * FROM Equipo where Id = '$IdUS'";
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Actualizar equipo</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="act-equipo.php" enctype="multipart/form-data" novalidate>
                                                ...
                                                <input id="Id" name="Id" type="hidden" value="<?=$IdUS?>">
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="file" class="form-control" name="Foto" id="Foto" accept="image/*"><?if(!empty($Foto)){?><a href="Equipo/<?=$FotoE?>" target="_blank">(Ver foto)</a><?}?>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														<div class="col-sm-12">
															...
															<input name="Volver" type="button" class="btn btn-warning" value="Volver"  onClick="location.href='act-equipo-2.php?Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>'">
														</div>
													</div>
												</form>
											</div><!--end .box-body -->
