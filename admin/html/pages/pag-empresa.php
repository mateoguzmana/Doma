									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="pag-empresa-2.php" enctype="multipart/form-data" novalidate>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="TituloIngles" id="TituloIngles" class="form-control" placeholder="Titulo inglés" value="<?=$TituloIngles?>" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<textarea name="DescripcionIngles" id="DescripcionIngles" class="form-control" placeholder="Descripcion inglés" onChange="javascript:this.value=this.value.toUpperCase();" rows="5" required><?=$DescripcionIngles?></textarea>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<?if(!empty($Foto)){?><a href="General/Empresa/<?=$Foto?>">(Ver foto)</a><?}?>
																</div>
															</div>
														</div>
													</div>
													<div class="form-group">
														<div class="col-sm-12">
															...
															<button type="button" class="btn btn-support5" onclick="location.href='act-equipo-2.php?Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>'">Ver equipo</button>
															<button type="button" class="btn btn-support3" onclick="location.href='ing-equipo-2.php?Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>'">Ingresar equipo</button>
														</div>
													</div>
												</form>
											</div><!--end .box-body -->
