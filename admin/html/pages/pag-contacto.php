...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$SubtituloIngles 	=$row["SubtituloEN"];
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="pag-contacto-2.php" enctype="multipart/form-data" novalidate>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="Subtitulo" id="Subtitulo" class="form-control" placeholder="Sub-titulo" value="<?=$Subtitulo?>" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="SubtituloIngles" class="control-label">Sub-titulo inglés</label>
																	<input type="text" name="SubtituloIngles" id="SubtituloIngles" class="form-control" placeholder="Sub-titulo Ingles" value="<?=$SubtituloIngles?>" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<textarea name="DescripcionIngles" id="DescripcionIngles" class="form-control" placeholder="Descripcion Ingles" onChange="javascript:this.value=this.value.toUpperCase();" rows="5" required><?=$DescripcionIngles?></textarea>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<?if(!empty($Foto)){?><a href="General/Contacto/<?=$Foto?>">(Ver foto)</a><?}?>
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<?if(!empty($Foto2)){?><a href="General/Contacto/Fondo/<?=$Foto2?>">(Ver foto)</a><?}?>
																</div>
															</div>
														</div>
													</div>
