...
$queryka			="UPDATE Lonja set Titulo = '$Titulo', Descripcion='$Descripcion', TituloEN='$TituloIngles', DescripcionEN='$DescripcionIngles' WHERE Id='$Id'";
$resultka			=mysql_query($queryka, $id);	

if(!empty($_FILES["Foto"]["name"])){

$Destino = "General/Lonja";
	...
	move_uploaded_file ($Imagen, $Destino . '/'.$Nombre);
		...
		$query1 = "UPDATE Lonja SET Foto='$Nombre' WHERE Id='$Id'"; 
		$result1=mysql_query($query1,$id);

}

$UsuarioACC     =  $_SESSION["usuario"];
$AccionACC      =  "Actualizó información de la lonja, página de inicio.";
