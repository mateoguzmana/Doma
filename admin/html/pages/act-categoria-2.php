...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$query2				="SELECT * FROM Sesion WHERE Id='$Id'";
					$result2 			=mysql_query($query2,$id);
					while($row2 		=mysql_fetch_array($result2)){
					$Nombre 			=$row2["Nombre"];
					$NombreEN 			=$row2["NombreEN"];
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Actualizar categoria</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-sesion.php" novalidate enctype="multipart/form-data">
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="NombreEN" id="NombreEN" class="form-control" placeholder="Nombre inglés" value="<?=$NombreEN?>" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="file" name="Imagen" id="Imagen" class="form-control" placeholder="Imagen" accept="image/*">
																	<?if(!empty($Imagen)){?><a href="Sesion/<?=$Imagen?>">(Ver foto)</a><?}?>
																</div>
															</div>
														</div>
													</div>
