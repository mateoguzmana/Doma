								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Ingresar categoria</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-categoria-2.php" novalidate enctype="multipart/form-data">
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="text" name="NombreEN" id="NombreEN" class="form-control" placeholder="Nombre inglés" value="" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
