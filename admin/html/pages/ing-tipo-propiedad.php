								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Crear tipo de propiedad</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-tipo-propiedad-2.php" novalidate>
                                                        <?
														}
														else
														{
															...
															<div class="form-group">
                                                              <div class="col-sm-12">
																<label for="Nombre" class="control-label">Nombre</label>
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Ingrese un Nombre" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
                                                              <div class="col-sm-12">
																<label for="NombreEN" class="control-label">Nombre inglés</label>
																	<input type="text" name="NombreEN" id="NombreEN" class="form-control" placeholder="Ingrese un nombre en inglés" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
